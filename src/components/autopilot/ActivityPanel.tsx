...
const EVENT_ICONS: Record<string, React.ReactNode> = {
  ...
  transport_started: <Loader className="w-3.5 h-3.5 text-cyan-400 animate-spin" />,
  transport_retry: <Clock className="w-3.5 h-3.5 text-amber-300" />,
  transport_fallback: <AlertCircle className="w-3.5 h-3.5 text-orange-400" />,
  transport_fallback_skipped: <AlertCircle className="w-3.5 h-3.5 text-red-400" />,
  json_retry: <Loader className="w-3.5 h-3.5 text-fuchsia-400 animate-spin" />,
