...
import { sanitizeAgentSignalSummary } from '@/lib/agent-signal-text';
...
export async function POST(
  ...
  try {
    ...
    const reason = typeof body?.reason === 'string' ? sanitizeAgentSignalSummary(body.reason) : '';
    ...
    endActiveTaskSessions(taskId, new Date().toISOString());
