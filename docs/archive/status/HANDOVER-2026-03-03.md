...
> [!NOTE]
> Historical handover snapshot. This document is preserved for context only and is not the current state of the repo. Use [docs/CURRENT_LOCAL_STATUS.md](../../CURRENT_LOCAL_STATUS.md) for current truth.
